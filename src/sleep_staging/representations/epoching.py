"""Handoff from preprocessing → representations.
...
from sleep_staging.representations.exceptions import EpochExtractionError
from sleep_staging.representations.types import EpochTensorBatch, LabelVocabulary
