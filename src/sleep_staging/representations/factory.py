...
from sleep_staging.representations.base import BaseEncoder
...
from sleep_staging.representations.exceptions import EncodingError
...
def build_encoder(settings: EncodingSettings) -> BaseEncoder:
    ...
    if representation == "raw":
        from sleep_staging.representations.types import LabelVocabulary
